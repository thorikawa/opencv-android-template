package com.polysfactory.cv.template.jni;
...
public class NativeExample {
    ...
    public NativeExample(String faceCascadeFile, String eyeCascadeFile1, String eyeCascadeFile2, String faceModelFile) {
